...
Illidan:AddOption("WarnEyeBeamSoon", true, DBM_ILLIDAN_OPTION_EYEBEAMSOON)
...
function Illidan:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(870 - delay, "Enrage", "Interface\\Icons\\Spell_Shadow_UnholyFrenzy");
end
...
function Illidan:OnSync(msg)
	...
	elseif msg:sub(0, 11) == "DarkBarrage" then
		...
		self:StartStatusBarTimer(45, "Next Dark Barrage", "Interface\\Icons\\Spell_Shadow_PainSpike")
	...
	elseif msg == "EyeBeam" then
        ...
        self.Options.WarnEyeBeamSoon then
			  self:ScheduleAnnounce(43, DBM_ILLIDAN_WARN_EYEBEAM_SOON, 2)
		    end
        self:StartStatusBarTimer(45, "Eye Beam", "Interface\\Icons\\Spell_Shadow_SiphonMana")
