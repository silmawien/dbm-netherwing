...
function Illidan:OnCombatStart()
	flameTargets = {}
	demonTargets = {}
	flamesDown = 0
	flameBursts = 0
	phase2 = nil
	phase4 = nil
	self:StartStatusBarTimer(900, "Enrage", "Interface\\Icons\\Spell_Shadow_UnholyFrenzy");	
end
...
function Illidan:OnEvent(event, args)
	if event == "CHAT_MSG_MONSTER_YELL" then
		...
		elseif args == DBM_ILLIDAN_YELL_START then
			self:StartStatusBarTimer(40.6, "Illidan Stormrage", "Interface\\Icons\\INV_Weapon_ShortBlade_07")
		end
