...
function Moroes:OnCombatStart(delay)
	self:StartStatusBarTimer(39, "Vanish", "Interface\\Icons\\Ability_Vanish");
	self:ScheduleSelf(34, "SoonWarning");
	self:StartStatusBarTimer(21, "Gouge", "Interface\\Icons\\Ability_Gouge");
end
