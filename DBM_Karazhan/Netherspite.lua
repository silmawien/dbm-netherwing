...
Netherspite:RegisterCombat("COMBAT", 0);
...
Netherspite:AddBarOption("Beams appear")
...
function Netherspite:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(15 - delay, "Beams appear", "Interface\\Icons\\Spell_Arcane_PortalSilvermoon");
end
...
function Netherspite:OnEvent(event, arg1)
	...
	elseif event == "PhaseWarning" and arg1 and self.Options.PhasePreWarn then
		if arg1 == 1 then
			...
			self:StartStatusBarTimer(11, "Beams appear", "Interface\\Icons\\Spell_Arcane_PortalSilvermoon");
		elseif arg1 == 2 then
