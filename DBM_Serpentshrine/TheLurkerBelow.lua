...
function Lurker:OnCombatStart(delay)
	self:StartStatusBarTimer(85, "Submerge", "Interface\\AddOns\\DBM_API\\Textures\\CryptFiendBurrow");
	self:ScheduleSelf(55 - delay, "SubmergeWarning", 30);
	self:ScheduleSelf(70 - delay, "SubmergeWarning", 15);
	self:ScheduleSelf(80 - delay, "SubmergeWarning", 5);
...
function Lurker:OnEvent(event, arg1)
	...
	elseif event == "Emerge" then
		...
		self:ScheduleSelf(55, "SubmergeWarning", 30);
		self:ScheduleSelf(70, "SubmergeWarning", 15);
		self:ScheduleSelf(80, "SubmergeWarning", 5);
