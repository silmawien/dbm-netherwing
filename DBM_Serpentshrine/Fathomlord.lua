...
Fathomlord:AddBarOption("Next Spitfire")
...
function Fathomlord:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(23 - delay, "Next Spitfire", "Interface\\Icons\\Spell_Fire_SearingTotem");
end
...
function Fathomlord:OnSync(msg)
	if msg == "TidalTotem" then
		...
		self:StartStatusBarTimer(26, "Next Spitfire", "Interface\\Icons\\Spell_Fire_SearingTotem");
