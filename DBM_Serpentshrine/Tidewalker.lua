...
function Tidewalker:OnCombatStart(delay)
	...
	self:StartStatusBarTimer(37 - delay, "Murlocs", "Interface\\Icons\\INV_Misc_MonsterHead_02");
...
function Tidewalker:OnEvent(event, arg1)
	...
	elseif event == "CHAT_MSG_RAID_BOSS_EMOTE" then
		if arg1 == DBM_TIDEWALKER_EMOTE_MURLOCS then
			self:StartStatusBarTimer(52, "Murlocs", "Interface\\Icons\\INV_Misc_MonsterHead_02");
		elseif arg1 == DBM_TIDEWALKER_EMOTE_GRAVE then
			self:StartStatusBarTimer(33, "Watery Grave", "Interface\\Icons\\Spell_Shadow_DemonBreath");
