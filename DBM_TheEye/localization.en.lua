...
DBM_KAEL_YELL_PHOENIX                   = "Anara'nel belore!"
DBM_KAEL_YELL_PHOENIX_TWO				= "By the power of the sun!"
DBM_KAEL_YELL_MINDCONTROL				= "Obey me."
...
DBM_KAEL_WARN_THALADRED_TARGET			= "*** Thaladred sets eyes on >%t< ***";
