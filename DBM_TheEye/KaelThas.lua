...
Kael:AddOption("WarnMindControl", true, DBM_KAEL_OPTION_WARNMINDCONTRL);
...
function Kael:OnEvent(event, arg1)
	...
	elseif event == "SPELL_AURA_APPLIED" then
		...
		elseif arg1.spellId == 36797 then
			self:StartStatusBarTimer(38, "Mind Control", "Interface\\Icons\\Spell_Shadow_Charm");
	...
	elseif event == "GravityLapseEnd" then
		gravityLapse = false;
		self:ScheduleSelf(85, "GravityWarn");
		self:StartStatusBarTimer(90, "Next Gravity Lapse", "Interface\\Icons\\Spell_Magic_FeatherFall");
...
function Kael:OnSync(msg)
	...
	elseif msg == "Phase4" then
		...
		self:ScheduleSelf(75, "BarrierWarn");
		self:StartStatusBarTimer(80, "Next Shock Barrier", "Interface\\Icons\\Spell_Nature_LightningShield");
		self:StartStatusBarTimer(9, "Phoenix", "Interface\\Icons\\Spell_FireResistanceTotem_01");
		self:StartStatusBarTimer(18, "Mind Control", "Interface\\Icons\\Spell_Shadow_Charm");
	...
	elseif msg == "Phoenix" then
		...
		self:StartStatusBarTimer(58, "Phoenix", "Interface\\Icons\\Spell_FireResistanceTotem_01");
	elseif msg == "MindControl" then
		if self.Options.WarnMindControl then
			self:Announce(DBM_KAEL_WARN_MINDCONTROL, 2);
		end
