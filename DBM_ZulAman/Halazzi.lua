...
Halazzi:AddBarOption("Totem")

function Halazzi:OnEvent(event, args)
	if event == "CHAT_MSG_MONSTER_YELL" then
		if arg1 == DBM_HALAZZI_YELL_SPIRIT then
			self:StartStatusBarTimer(13, "Totem", "Interface\\Icons\\Inv_Waepon_Bow_Zulgrub_d_02")
	...
	elseif event == "SPELL_SUMMON" then
		if args.spellId == 43302 then
			self:StartStatusBarTimer(20, "Totem", "Interface\\Icons\\Inv_Waepon_Bow_Zulgrub_d_02")
		end
