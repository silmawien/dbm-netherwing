...
function Malacrass:OnCombatStart()
	self:StartStatusBarTimer(29, "Next Spirit Bolts", "Interface\\Icons\\Spell_Shadow_ShadowBolt")
end
...
function Malacrass:OnEvent(event, args)
	...
	elseif event == "CHAT_MSG_MONSTER_YELL" then
		if arg1 == DBM_MALACRASS_YELL_BOLTS or arg1 == "Darkness comin' for you...." then
			self:SendSync("Bolts")
		end
	end
end
...
function Malacrass:OnSync(msg)
	...
	elseif msg == "Bolts" then
		self:StartStatusBarTimer(42, "Next Spirit Bolts", "Interface\\Icons\\Spell_Shadow_ShadowBolt")
