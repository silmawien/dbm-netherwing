...
function Akilzon:OnCombatStart()
	...
	self:StartStatusBarTimer(50, "Electrical Storm", "Interface\\Icons\\Spell_Lightning_LightningBolt01")
	self:ScheduleAnnounce(45, DBM_AKIL_WARN_STORM_SOON, 1)
...
function Akilzon:OnSync(msg)
	if msg:sub(0, 5) == "Storm" then
		...
		self:SetIcon(msg, 10)
		self:StartStatusBarTimer(66, "Electrical Storm", "Interface\\Icons\\Spell_Lightning_LightningBolt01")
		self:ScheduleAnnounce(61, DBM_AKIL_WARN_STORM_SOON, 1)
